...
<div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="{{ route('artists.store') }}" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" id="email" name="email" value="{{ old('email') }}" class="mt-1 block w-full p-2 border rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 @error('email') border-red-500 @enderror" required>
            @error('email')
